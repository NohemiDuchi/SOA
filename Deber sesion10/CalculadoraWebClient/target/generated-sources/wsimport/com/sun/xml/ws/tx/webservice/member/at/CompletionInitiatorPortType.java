 ...
 * 
 */
@WebService(name = "CompletionInitiatorPortType", targetNamespace = "http://schemas.xmlsoap.org/ws/2004/10/wsat")
...
public interface CompletionInitiatorPortType {
     ...
     * @param parameters
     */
    @WebMethod(operationName = "CommittedOperation", action = "http://schemas.xmlsoap.org/ws/2004/10/wsat/completion/Committed")
    @Oneway
     ...
     * @param parameters
     */
    @WebMethod(operationName = "AbortedOperation", action = "http://schemas.xmlsoap.org/ws/2004/10/wsat/completion/Aborted")
    @Oneway
